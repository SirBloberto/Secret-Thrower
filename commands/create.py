...
async def create(
    interaction: discord.Interaction, team1: discord.VoiceChannel, team2: discord.VoiceChannel, info: str = ""
):
    global games
    global json
    ...
    if team1 == team2:
        return await interaction.response.send_message(
            "Voice channels must be different. Please select two different voice channels",
            ephemeral=True,
            delete_after=60.0,
        )
